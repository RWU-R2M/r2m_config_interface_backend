...
This is a demonstration script that returns system status information in JSON format.
It's designed to show how to create synchronous scripts that return structured data.

This script is not intended for production use and is provided only as an example
of how to implement custom scripts with the API.

To create your own scripts, use this as a template but implement your actual
business logic instead of these example functions.
"""
import json
import os
import subprocess
